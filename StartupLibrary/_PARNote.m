...
// Make changes to PARNote.m instead.
...
const struct PARNoteRelationships PARNoteRelationships = {
	.book = @"book",
};

@implementation PARNoteID
@end

@implementation _PARNote
...
- (PARNoteID*)objectID {
	return (PARNoteID*)[super objectID];
}
